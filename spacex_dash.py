...
# TASK 2-A: Add a callback function for site-dropdown as input, success-pie-chart as output
...
# TASK 4-A: Add a callback function for site-dropdown and payload-slider as inputs, success-payload-scatter-chart as output
